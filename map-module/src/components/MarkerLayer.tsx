        ...
        return (
          ...
          >
            <div className="relative cursor-pointer group" style={{ width: 20, height: 20 }}>
              ...
              <div
                className="absolute bottom-7 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs px-2 py-1 rounded-lg pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150"
                style={{
